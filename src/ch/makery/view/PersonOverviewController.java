...
/**
 * Created by ЭМПРиО on 19.10.2016.
 */
public class PersonOverviewController {
    ...
    //после того, как fxml будет загружетн
    @FXML
    private void initialize(){
        ...
        //Слушаем изменения выбора, и при изменении отображаем дополнительную информацию
     ...
     * Если указанный адресат = null, то все текствые поля очищаются.
     **/
